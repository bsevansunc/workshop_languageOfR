...
<li><div class = "roundBorderEx">Blue boxes provide any hotkeys, vocabulary, and best management practices associated with a lesson. Pay careful attention to the material in blue boxes!</div></li>
</ul>
...
<br>
<br>
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Open R Studio and create a new R <b>script</b> in the <b>source panel</b> using the keyboard combination <i>CTRL+SHIFT+N</i>. Even before you begin writing any <b>code</b>, it's good to save the script you will be working on. Save the script onto your computer using the keyboard combination <i>CTRL+S</i>. Name the file "rIntro" (<i>note: the extension, ".R" will be assigned automatically</i>).</p>

<!-- source panel -->

<h3>The source panel</h3>
<p>The <b>source panel</b> provides a useful interface for writing and editing code and is a great tool for observing and communicating what you have done. To execute code from the <b>source panel</b>, place your cursor on the line of code you would like to run and use the keyboard shortcut CTRL+Enter. To run multipe lines of code at once, use your mouse to select the section of code you would like to run and hit CTRL+Enter. </p>
<br>

<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Type `1+1+2` on the first line of your script in the <b>source panel</b>. Use the keyboard shortcut CTRL+Enter to execute the line of code that the cursor is on.</p>
<br>
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Type or copy-and-paste the following into the <b>source panel</b>, select the section of code with your mouse, and run the section using CTRL+Enter:</p> 
...
<p><i class="fa fa-user-secret" aria-hidden="true" style = "font-size: 150%"></i>
 Any code that you will use more than once or upon which future lines of code depend should always be written and executed in the <b>source panel</b>.
</p>
</div>
...
<p> The console panel provides the command line interface to the R program itself. When a line of code is run from the command prompt (`>`) on the console, the interface sends the code to R and R evaluates the code and returns any potential output.</p>

<p>When you ran the above sections of code from the <b>source panel</b>, you should have noticed that the code input and output was provided in the console panel.This highlights a key component of the internal R Studio workflow: code is written in the <b>source panel</b> and delivered to the console panel (CTRL+Enter) which then communicates with R to evaluate the code.</p>

<p>You can run code directly from the console panel. To do so, simply type the code you would like to run and press enter.</p>

<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Type `1+1+2` after the command prompt on the console panel and press enter to run the code.</p>
<br>
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Copy-and-paste the following into the <b>source panel</b> and press enter to run the section:</p> 
...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> You can use your keyboard to navigate between lines of code you've run in the console. This can be especially useful for modifying part of a section of code. For example, use the up arrow on your keyboard to change the line `1+1+2` to `1+1+2+3`.</p>
...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Enter or copy-and-paste the following into your <b>source panel</b> and execute using CTRL+Enter:</p>
...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Try running the following from the <b>source panel</b> and observe what happens:</p>
...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Combine the integers 1, 1, and 2 into a single object (the combine function in R is `c`) in the <b>source panel</b> and name the object `firstVector`:</p>
...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> In the <b>source panel</b>, make an object with two integers and an NA. In the console panel, calculate the mean of the data with (na.rm = TRUE) and without (na.rm = FALSE) the modifier argument:</p>
...
<div class = "roundBorderBlack">
<br>
<p><i class="fa fa-user-secret" aria-hidden="true" style = "font-size: 150%"></i> Libraries should always be loaded in the <b>source panel</b>! It's best to load libraries one of three locations of your script:</p>
<ul>
...
<li>CTRL+Enter: Execute line or section of code from the <b>source panel</b>
</ul>
...
<ul>
<li>Any code that you will use more than once should be written and executed in the <b>source panel</b></li>
