...
<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Enter `firstSet` and `c(1,1,2)` in the console panel (separately) and note the output for each.</p>

<p><i class="fa fa-user-circle-o" aria-hidden="true" style = "font-size: 150%"></i> Because `firstSet` <i>IS</i> `c(1,1,2)`, the assigned name and the object are interchangeable.</p>
